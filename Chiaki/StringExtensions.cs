...
public static class StringExtensions
{
    ...
    public static string Mask(this string sourceValue, char maskChar, int numExposed, EStringMaskStyle style)
    {
        var masked = sourceValue;

        if (sourceValue.IsLengthAtLeast(numExposed))
        {
            var builder = new StringBuilder(sourceValue.Length);
            int index = masked.Length - numExposed;

            if (style == EStringMaskStyle.AlphaNumericOnly)
            {
    ...
    {
        return Mask(sourceValue, maskChar, numExposed, EStringMaskStyle.All);
    }
    ...
    {
        return Mask(sourceValue, maskChar, 0, EStringMaskStyle.All);
    }
    ...
    {
        return Mask(sourceValue, '*', numExposed, EStringMaskStyle.All);
    }
    ...
    {
        return Mask(sourceValue, '*', 0, EStringMaskStyle.All);
    }
    ...
    /// <returns>The masked account number.</returns>
    public static string Mask(this string sourceValue, char maskChar, EStringMaskStyle style)
    {
    ...
    /// <param name="style">The masking style to use (all characters or just alpha-nums).</param>
    /// <returns>The masked account number.</returns>
    public static string Mask(this string sourceValue, int numExposed, EStringMaskStyle style)
    {
    ...
    /// <param name="style">The masking style to use (all characters or just alpha-nums).</param>
    /// <returns>The masked account number.</returns>
    public static string Mask(this string sourceValue, EStringMaskStyle style)
    {
    ...
    /// <summary>
    /// Replaces the first occurrence of a string within a string, and replaces it with another string.
    /// </summary>
